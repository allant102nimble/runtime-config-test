...
public class RandomBean2 {
    ...
    public RandomBean2(RefreshableProperties refreshableProperties) throws BindException {
        System.out.println("RandomBean2: new instance");
        this.property = refreshableProperties.getProperty1();
    }

    public String bye() {
        String[] dependentBeanNames = ((ConfigurableApplicationContext)applicationContext).getBeanFactory().getDependenciesForBean(RefreshableProperties.class.getName());
